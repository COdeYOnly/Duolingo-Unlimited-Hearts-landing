const LandingPage = () => {
  ...
  const features = [{"num":"01","title":"Access Duolingo Max","desc":"Unlock advanced learning tools and premium content without a subscription."},{"num":"02","title":"Unlimited Hearts","desc":"Continue your lessons without interruptions from limited hearts."},{"num":"03","title":"Cross-Browser Compatibility","desc":"Install and use on Chrome, Firefox, Edge, Brave, Opera, Tor, LibreWolf, and Waterfox."},{"num":"04","title":"Mobile Support","desc":"Enhance your Duolingo experience on Firefox for Android and iOS Safari via Userscripts."}];
  const steps    = [{"num":"1","title":"Install the Extension","desc":"Find Duolingo Max in your browser's store or download from GitHub releases."},{"num":"2","title":"Add to Browser","desc":"Click 'Add to Chrome' or 'Add to Firefox' to install the extension."},{"num":"3","title":"Enjoy Enhanced Learning","desc":"Refresh Duolingo and start using premium features immediately."}];
    ...
    <div style={{ background: BG, color: FG, fontFamily: MONO, minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <nav style={{
        ...
        <div style={{ display:"flex", alignItems:"center", gap:36 }}>
          ...
          <button className="lk-btn" onClick={() => window.open("https://github.com/apersongithub/Duolingo-Unlimited-Hearts", "_blank")} style={{
        ...
        <div style={{ position:"relative", zIndex:1, maxWidth:1100, margin:"0 auto", padding:"80px 48px 60px", width:"100%" }}>
          ...
          <div className="lk-a lk-d4" style={{ display:"flex", alignItems:"flex-end", gap:64, flexWrap:"wrap", marginBottom:56 }}>
            <p style={{ color:MUTED, fontSize:16, lineHeight:1.85, maxWidth:460, margin:0 }}>
              "This extension grants Duolingo Max and other paid features for free. Language learners can enjoy an uninterrupted, enhanced experience across multiple platforms."
            </p>
            <div style={{ display:"flex", flexDirection:"column", gap:12, flexShrink:0 }}>
              ...
              <a className="lk-ghost" href={"https://github.com/apersongithub/Duolingo-Unlimited-Hearts"} target="_blank" rel="noreferrer" style={{
          ...
          <div className="lk-a lk-d5" style={{
            ...
            <p style={{ fontFamily:SERIF, fontSize:20, fontStyle:"italic", color:FG, lineHeight:1.4, margin:0 }}>
              &ldquo;{"Unlock Duolingo Max and paid features for free."}&rdquo;
            </p>
          </div>
      ...
      <footer style={{ borderTop:`1px solid ${DIM}`, padding:'32px 48px' }}>
        <div style={{ maxWidth:1100, margin:"0 auto", display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:16 }}>
          <div style={{ display:"flex", alignItems:"center", gap:10 }}>
            ...
            <span style={{ fontFamily:SERIF, fontSize:16, fontWeight:600 }}>"Duolingo-Unlimited-Hearts"</span>
            <span style={{ color:DIM, fontSize:12, marginLeft:4 }}>—</span>
            <span style={{ color:MUTED, fontSize:12 }}>"Duolingo Max, no cost."</span>
          </div>
